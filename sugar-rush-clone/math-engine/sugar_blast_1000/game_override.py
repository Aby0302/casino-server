"""
Sugar Blast 1000 — GameState Override
...
class GameStateOverride(GeneralGameState):
    """
    Overrides core state functions for Sugar Blast 1000.
    Sugar Blast has no wild symbols, so no special_symbol_functions are needed.
    """

    def assign_special_sym_function(self):
        """Sugar Blast 1000 has no wild or special-function symbols."""
        self.special_symbol_functions = {}

    def reset_book(self):
        """
        Resets all game state for a new simulation.
        Adds Sugar Blast-specific: 7×7 multiplier grid.
        """
        super().reset_book()
